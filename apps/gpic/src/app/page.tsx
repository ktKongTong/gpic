...
import {useImageGenerate} from "@/components/image-generate";
import {useGenerateTasks} from "@/hooks/use-generate-task";
...
export default function DrawPage() {
  ...
  // 如何避免重复请求？，3分钟之内只能提交一次请求，直到上一个请求失败。
  const genTask = async () => {
    if(state != states.NOT_START) {
      toast('在画了..在画了！')
      return
        ...
        <section id="tools" className="w-full max-w-4xl mx-auto mb-20 scroll-mt-24">
          ...
          <div className="glass-container p-8 rounded-2xl backdrop-blur-md bg-card/40 shadow-xl">
            ...
            <div className="mt-6 space-y-4">
              ...
              {
                url ? (
                  <div className={'w-64 min-h-64 mx-auto bg-black/20 rounded-lg relative'}>
                    {
