// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c0bde602a95678b22cd330a58854c8e8)
// Runtime types generated with workerd@1.20250321.0 2025-03-21 nodejs_compat
// import {BatchTaskStateDO} from "./src";

declare namespace Cloudflare {
    type BatchTaskStateDO = DurableObject & {
        batchState: BatchState
        initialize: () => Promise<void>
        updateState: (state: BatchState) => Promise<void>
        getState: () => Promise<BatchState>
        onCreateSubTask: (count: number) => Promise<void>
        onTaskStatusUpdate: (statusChange: StatusChange) => Promise<void>
    }
	interface Env {
		KV: KVNamespace;
		NEXTJS_ENV: string;
		...
		S3_SK: string;
		S3_ENDPOINT: string;
		S3_UC_ENDPOINT: string;
		S3_BUCKET: string;
		S3_USER_CONTENT_ENDPOINT: string;
